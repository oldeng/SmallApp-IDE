const code_sharing = require('js/code_sharing.js');
const last_session = require('js/last_session.js');
//终端模块
...
if(settings_file.theme) changeCSS('/editor/theme/' + settings_file.theme, 1);
